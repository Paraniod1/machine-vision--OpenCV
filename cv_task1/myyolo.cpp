...
Net_config yolo_nets[4] = {
    {0.2, 0.2, 0.52, "yolov5s"},
    {0.5, 0.5, 0.5,  "yolov5m"},
    {0.5, 0.5, 0.5, "yolov5l"},
    {0.5, 0.5, 0.5, "yolov5x"}
};

MyYolo::MyYolo(Net_config config)
{
...
void MyYolo::drawPred(int classId, float conf, int left, int top, int right, int bottom, Mat& frame)   // Draw the predicted bounding box
{
...
void MyYolo::sigmoid(Mat* out, int length)
{
